...
class Project_ManageController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $workingsites = $this->_site->findBy(array("completed" => false));
        $nullsites = $this->_site->findBy(array("completed" => null));
        $this->view->workingsites = array_merge($workingsites, $nullsites);

        $completedsites = $this->_site->findBy(array("completed" => true));
        $this->view->completedsites = $completedsites;
    }
