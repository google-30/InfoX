...
'updatedata', 'submitmatapps','reviewmatapps','rejectmatapps', 'approvematapps'),
		...
		'acl'=>array(
            ...
            'salary:salary'=>array('view', 'personalsalary', 'salarybymonth', 'gensalaryrecords', 
...
'submitmatapps','reviewmatapps','rejectmatapps','previewform','previeworder', 'polist', 'appapprove'),
            ...
            'material:po'=>array('view', 'submit', 'truncateall'),            
